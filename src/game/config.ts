...
export const ROSTER_CYAN: FighterProfile[] = [
  {
    ...
    avatarIcon: "07",
    quote: "Launching opponents into the stratosphere is my specialty!",
    statPunch: 5,
    statSpeed: 4,
    statChaos: 5,
  },
  {
    ...
    title: "BEAT STRIKER",
    avatarIcon: "01",
    quote: "Drop the bass, drop the rival right over the ropes!",
    statPunch: 3,
    statSpeed: 5,
    statChaos: 4,
  },
  {
    ...
    title: "SHADOW DASHER",
    avatarIcon: "02",
    quote: "Blink once, and you are already flying into the abyss!",
    statPunch: 4,
    statSpeed: 5,
    statChaos: 3,
  },
...
export const ROSTER_CORAL: FighterProfile[] = [
  ...
  },
  {
    ...
    avatarIcon: "02",
    quote: "You cannot hit what is bouncing circles around you!",
    statPunch: 3,
    statSpeed: 5,
    statChaos: 5,
  },
  {
    ...
    title: "THE IRON WALL",
    avatarIcon: "03",
    quote: "This ring belongs to us. Time for your eviction!",
    statPunch: 4,
    statSpeed: 3,
    statChaos: 3,
  },
